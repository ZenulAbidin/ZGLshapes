#define BOOST_TEST_MODULE Z_QTShapes_QEllipseF_3
...
BOOST_AUTO_TEST_CASE(Z_QEllipseF_3)
{
    z_qtshapes::ZQEllipseF g(10, 20, 30, 40, 90);
    g.setCoords(1, 2, 3, 4);
    BOOST_TEST(g.px1() == 1);
    BOOST_TEST(g.py1() == 2);
    BOOST_TEST(g.px2() == 3);
    ...
    z_qtshapes::ZQEllipseF h(1, 2, 3, 4, 90);

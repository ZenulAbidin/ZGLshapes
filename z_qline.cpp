...
namespace z_qtshapes {
    ...
    */
    ZQLine ZQLine::fromPolar(int length, int angle) const noexcept
    {
    ...
    */
    ...
    /*!
        \fn void ZQLine::normalizeAngle() const
    ...
    */
    ...
    /*!
        ...
        mean the clockwise direction. Zero degrees is at the 3 o'clock position.
    */
    ZQLineF ZQLineF::fromPolar(qreal length, qreal angle) const noexcept
    {
        const qreal angleR = angle * M_2PI / 360.0;

...
namespace z_qtshapes {
    ...
    public:
        ...
        ZQLineF fromPolar(qreal length, qreal angle) noexcept;
    ...
    inline void ZQLine::normalizeAngle() noexcept
    {
        while (a < 0)
            a += 360 * MAX_ROTATIONS;
    ...
    inline int ZQLine::normalizeAngle(int a) noexcept
    {
        while (a < 0)
            a += 360 * MAX_ROTATIONS;
        while (angle > 360 * MAX_ROTATIONS)
    ...
    inline void ZQLineF::normalizeAngle() noexcept
    {
        while (a < 0)
            a += 360 * MAX_ROTATIONS;
        while (angle > 360 * MAX_ROTATIONS)

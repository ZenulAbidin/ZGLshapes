...
namespace z_qtshapes {
    ...
    inline bool ZQTriF::isAcute() const noexcept
    {
        ...
        qreal a2 = 180/M_PI * qAcos(qPow(l13, 2) - qPow(l12, 2) - qPow(l23, 2) + 2 * l12 * l23);        
        qreal a3 = 180/M_PI * qAcos(qPow(l12, 2) - qPow(l13, 2) - qPow(l23, 2) + 2 * l13 * l23);
        if (a1 < 90 && !qFuzzyCompare(a1, 90) && a2 < 90 && !qFuzzyCompare(a2, 90) && a3 < 90 && !qFuzzyCompare(a3, 90)) {
            return true;
        }
        return false;
    }
    ...
    inline bool ZQTriF::isRight() const noexcept
    {
        ...
        qreal a2 = 180/M_PI * qAcos(qPow(l13, 2) - qPow(l12, 2) - qPow(l23, 2) + 2 * l12 * l23);        
        qreal a3 = 180/M_PI * qAcos(qPow(l12, 2) - qPow(l13, 2) - qPow(l23, 2) + 2 * l13 * l23);
        if (qFuzzyCompare(a1, 90) || qFuzzyCompare(a2, 90) || qFuzzyCompare(a3, 90)) {
            return true;
        }
        return false;
    }
    ...
    inline bool ZQTriF::isIso() const noexcept
    {
        ...
        qreal a2 = 180/M_PI * qAcos(qPow(l13, 2) - qPow(l12, 2) - qPow(l23, 2) + 2 * l12 * l23);        
        qreal a3 = 180/M_PI * qAcos(qPow(l12, 2) - qPow(l13, 2) - qPow(l23, 2) + 2 * l13 * l23);
        if (qFuzzyCompare(a1, a2) || qFuzzyCompare(a2, a3) || qFuzzyCompare(a3, a1)) {
            return true;
        }
        return false;
    }
    ...
    inline bool ZQTriF::isEquilateral() const noexcept
    {
        ...
        qreal a2 = 180/M_PI * qAcos(qPow(l13, 2) - qPow(l12, 2) - qPow(l23, 2) + 2 * l12 * l23);        
        qreal a3 = 180/M_PI * qAcos(qPow(l12, 2) - qPow(l13, 2) - qPow(l23, 2) + 2 * l13 * l23);
        if (qFuzzyCompare(a1, 60) && qFuzzyCompare(a2, 60) || qFuzzyCompare(a3, 60)) {
            return true;
        }
        return false;
    }
